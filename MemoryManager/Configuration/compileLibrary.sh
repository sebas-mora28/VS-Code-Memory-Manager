...
gcc -Wall -Wextra -o GarbageCollector.o -c -fPIC ../GarbageCollector/GarbageCollector.cpp
...
g++ -shared -o libVSCodeRemote.so ClientSocket.o RemoteMemory.o InializeClient.o -ljsoncpp
